...
/** Compact page hero used on every interior page. */
export function PageHero({
  ...
  return (
    <section className="relative flex min-h-[62vh] items-end overflow-hidden pb-16 pt-40 sm:min-h-[68vh] sm:pb-24">
      ...
      />
      <div aria-hidden className="absolute inset-0 bg-gradient-to-t from-ink/85 via-ink/45 to-ink/25" />
      <Container className="relative">
        <AnimatedSection className="max-w-3xl text-ivory">
          ...
          {lede && (
            <p className="mt-6 max-w-xl text-[15px] font-light leading-[1.85] text-ivory/75">{lede}</p>
          )}
        </AnimatedSection>
      </Container>
    </section>
